...
public class PreRequisiteQuestion {
    ...
    public PreRequisiteQuestion() {
    }

    public PreRequisiteQuestion(String questionId, String questionCat, String question, String option1, String option2, String option3, String option4, String answer) {
